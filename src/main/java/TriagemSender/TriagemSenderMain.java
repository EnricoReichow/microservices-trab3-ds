    ...
    public static void main(String[] args) throws Exception {
        ...
        try (Connection connection = factory.newConnection();
            ...
            DeliverCallback deliverCallback = (consumerTag, delivery) -> {
                ...
                channel.basicPublish(EXCHANGE_NAME, destinoKey, null, updatedMessage.getBytes("UTF-8"));
                System.out.println("Paciente " + paciente.getNome() + " encaminhado para " + paciente.getMedicoResponsavel());
